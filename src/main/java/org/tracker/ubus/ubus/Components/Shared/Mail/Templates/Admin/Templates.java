...
public record Templates() {
    ...
    public static String buildBusStatusHtml(String firstName, String lastName, String status) {
        boolean isMaintenance = "Maintenance".equalsIgnoreCase(status);
        String statusDisplay = isMaintenance ? "Under Maintenance" : "Out of Service";
        String message = isMaintenance
                ? "The maintenance team is working to resolve the issue. You will be notified once the bus is back in service."
                : "Please contact your supervisor immediately for further instructions regarding your shift.";
        ...
        html.append("    <meta charset=\"utf-8\">\n");
        html.append("    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n");
        html.append("    <title>UBus Bus Status Notification</title>\n");
        html.append("</head>\n");
        html.append("<body style=\"margin: 0; padding: 0; background-color: #ffffff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased;\">\n");
        html.append("    <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" style=\"max-width: 600px; margin: 0 auto; background-color: #ffffff;\">\n");
        ...
        html.append("            <td style=\"padding: 20px 40px 40px 40px;\">\n");
        html.append("                <p style=\"font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.12em; color: #f26522; margin: 0 0 16px 0;\">\n");
        html.append("                    Bus Status Update\n");
        html.append("                </p>\n");
        html.append("                <h1 style=\"font-size: 36px; font-weight: 800; color: #000000; line-height: 1.1; margin: 0 0 24px 0; letter-spacing: -0.04em;\">\n");
        html.append("                    Hello, ").append(firstName).append(" ").append(lastName).append("!<br/>\n");
        html.append("                    <span style=\"color: #f26522;\">Your Bus is ").append(statusDisplay).append("</span>\n");
        html.append("                </h1>\n");
        html.append("                <p style=\"font-size: 16px; line-height: 1.6; color: #474747; margin: 0 0 12px 0;\">\n");
        html.append("                    This is to inform you that the bus assigned to your route is currently <strong>").append(statusDisplay).append("</strong>.\n");
        html.append("                </p>\n");
        html.append("                <p style=\"font-size: 16px; line-height: 1.6; color: #474747; margin: 0 0 32px 0;\">\n");
        html.append("                    ").append(message).append("\n");
        html.append("                </p>\n");
        html.append("                <p style=\"font-size: 14px; color: #777777; margin: 32px 0 0 0;\">\n");
        html.append("                    If you have any questions, please don't hesitate to reach out to your supervisor or the UBus support team.\n");
        html.append("                </p>\n");
        ...
        html.append("                            <td>\n");
        html.append("                                <span style=\"font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.1em; color: #000000; margin-left: 8px;\">\n");
        html.append("                                    Status: ").append(statusDisplay).append("\n");
        html.append("                                </span>\n");
        html.append("                            </td>\n");
        html.append("                        </tr>\n");
        html.append("                    </table>\n");
        ...
        html.append("            <td style=\"padding: 60px 40px 40px 40px;\">\n");
        html.append("                <p style=\"font-size: 11px; font-weight: 500; color: #777777; text-transform: uppercase; letter-spacing: 0.1em; margin: 0 0 12px 0;\">\n");
        html.append("                    © 2026 UBus. All rights reserved.\n");
        html.append("                </p>\n");
        html.append("                <div style=\"font-size: 11px; font-weight: 500; color: #777777; text-transform: uppercase; letter-spacing: 0.1em;\">\n");
        html.append("                    <a href=\"#\" style=\"color: #777777; text-decoration: none; margin-right: 15px;\">Privacy</a>\n");
        html.append("                    <a href=\"#\" style=\"color: #777777; text-decoration: none; margin-right: 15px;\">Terms</a>\n");
    ...
    public static String buildDriverRegistrationSuccessHtml(String firstName, String lastName) {
        StringBuilder html = new StringBuilder();
        ...
        html.append("    <meta charset=\"utf-8\">\n");
        html.append("    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n");
        html.append("    <title>Registration Successful - UBus</title>\n");
        html.append("</head>\n");
        html.append("<body style=\"margin: 0; padding: 0; background-color: #ffffff; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; -webkit-font-smoothing: antialiased;\">\n");
        html.append("    <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\" style=\"max-width: 600px; margin: 0 auto; background-color: #ffffff;\">\n");
        ...
        html.append("            <td style=\"padding: 20px 40px 40px 40px;\">\n");
        html.append("                <p style=\"font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.12em; color: #f26522; margin: 0 0 16px 0;\">\n");
        html.append("                    Registration Successful\n");
        html.append("                </p>\n");
        html.append("                <h1 style=\"font-size: 36px; font-weight: 800; color: #000000; line-height: 1.1; margin: 0 0 24px 0; letter-spacing: -0.04em;\">\n");
        html.append("                    Welcome to UBus,<br/>").append(firstName).append(" ").append(lastName).append("!\n");
        html.append("                </h1>\n");
        html.append("                <p style=\"font-size: 16px; line-height: 1.6; color: #474747; margin: 0 0 12px 0;\">\n");
        html.append("                    Your driver registration with UBus has been successfully completed.\n");
        html.append("                </p>\n");
        html.append("                <p style=\"font-size: 16px; line-height: 1.6; color: #474747; margin: 0 0 12px 0;\">\n");
        html.append("                    An administrator will be in contact with you shortly to provide further details and next steps.\n");
        html.append("                </p>\n");
        html.append("                <p style=\"font-size: 16px; line-height: 1.6; color: #474747; margin: 0 0 32px 0;\">\n");
        html.append("                    We look forward to having you on the team!\n");
        html.append("                </p>\n");
        html.append("                <p style=\"font-size: 14px; color: #777777; margin: 32px 0 0 0;\">\n");
        html.append("                    If you have any questions, please don't hesitate to reach out to the UBus support team.\n");
        html.append("                </p>\n");
        html.append("            </td>\n");
        html.append("        </tr>\n");
        ...
        html.append("                            <td>\n");
        html.append("                                <span style=\"font-size: 10px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.1em; color: #000000; margin-left: 8px;\">\n");
        html.append("                                    Awaiting Administrator Contact\n");
        html.append("                                </span>\n");
        html.append("                            </td>\n");
        html.append("                        </tr>\n");
        html.append("                    </table>\n");

...
public class JwtService {
    ...
    public JwtService(@Qualifier("jwtKeyGenerator") ISecretKeyGenerator secretKeyGenerator) {
    ...
    public String generateToken(UserDetails userDetails, String role) {
        ...
        SecretKey secretKeyObject = this.secretKeyGenerator.generateSecretKey(secretKey);
